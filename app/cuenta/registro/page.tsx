    ...
    <CustomerThemeFrame requestedReturnTo={returnTo ?? next}>
      <main className={styles.loginPage}>
        <section className={styles.loginCard}>
          ...
          <p>Administra todas tus reservaciones desde un solo lugar.</p>
          {(claim || returnTo) && <p className={styles.authContext}>Usa el mismo correo que registraste en tu reservación para continuar.</p>}
          <CustomerRegistrationForm next={next} returnTo={returnTo} claim={claim} />
        </section>
      </main>
    </CustomerThemeFrame>
  );
