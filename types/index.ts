...
export type RoomCapacityPolicy = { enabled: boolean; defaultMaxGuestsPerRoom: number; allowMultipleRooms: boolean; maxRoomsPerBooking?: number; adultCountsTowardCapacity: boolean; minorCountsTowardCapacity: boolean; infantCountsTowardCapacity?: boolean };
export type RoomAllocation = { roomNumber: number; adults: number; minors: number; occupancyBase: "single" | "double" | "triple" | "quadruple" };
...
export type AgencySettings = { visibleSections: string[]; modules: string[]; legalNotice: string; whatsapp?: AgencyWhatsAppSettings; socialSettings?: AgencySocialSettings; roomCapacityPolicy?: RoomCapacityPolicy; availabilityDisplayMode?: AvailabilityDisplayMode; travelerCategories?: TravelerCategory[]; extraVisibility?: ExtraVisibility };
...
export type TravelPricingOption = { id: string; label: string; occupancy: "single" | "double" | "triple" | "quadruple" | "child" | "infant" | "general"; amount: number; currency: Currency; taxesAmount?: number; inventoryImpact: number; maxGuestsPerRoom?: number };
