import { z } from "zod";
export const demoQuerySchema=z.object({tenant:z.enum(["furiver","crisenix","boutique"]).optional(),theme:z.enum(["explorer","boutique","marketplace"]).optional(),view:z.enum(["public","admin"]).optional()});
