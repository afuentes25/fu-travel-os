...
export const agencies: Agency[] = [
  { id: "a-furiver", slug: "furiver", name: "Furiver Demo", status: "active", theme: "explorer", plan: "growth", currency: "MXN", timezone: "America/Mexico_City", locale: "es-MX", contact: { whatsapp: "525500000101", email: "hola@furiver.demo", facebook: "furiver.demo" }, branding: { logoText: "FURIVER", primaryColor: "#101b22", accentColor: "#ef8b45", heroImage: "/images/explorer-hero.webp", heroTitle: "México se vive en el camino", heroDescription: "Excursiones, playa y pueblos mágicos con salidas desde la ciudad.", buttonStyle: "rounded" }, settings: { visibleSections: ["featured", "departures", "destinations", "benefits", "testimonials"], modules: ["catalog", "booking", "whatsapp"], legalNotice: "Información demostrativa. No constituye una oferta comercial." } },
